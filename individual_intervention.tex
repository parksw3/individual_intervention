...
\swp{See if you like the edit}
The forward renewal equation further allows us to verify that the instantaneous quantities ($\Ri(t)$ and $g(t, \tau)$) matches the forward realized quantities ($\Rc(t)$ and $f_t(\tau)$) when conditions remain constant, a key premise in defining instantaneous quantities:
...
\swp{It's there. I think you'll get to it very soon.}
...
Our study highlights the value of growth rates in characterizing epidemic spread.
...
Our study has practical implications for describing disease dynamics and communicating model estimates.
