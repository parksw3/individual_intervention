...
When interventions are not purely strength-based, however, the exact meaning of this estimator difficult to interpret; 
and it does not necessarily accurately reflect how conditions are changing through time \jd{Do we need to think about threshold values? Nothing except $r$ is an instaneous threshold value, and everything is a long-term threshold value.}
