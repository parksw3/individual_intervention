...
Here we extend the strength--speed framework to span between the instantaneous and case-based perspectives. We begin by showing that the renewal process of infection can be expressed in two equivalent ways.
\jd{I struggled with changing the 2ss below. We could shorten using “corresponds to” if you like.}
...
\jd{Added an unnecessary parenthetic remark because I want to help people navigate why $K$ might be constant, and in particular don't want them to over-interpret.}
...
\jd{Not sure what the following s. is trying to add; can we lose it?}
