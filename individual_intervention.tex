...
For example, given constant hazard $h(\tau)$ of being isolated between time \tstart and \tend, the probability that an individual infected at time $t$ has not been isolated by $\tau$ time units after infection depends on the amount of time the individual has been exposed to this intervention.
