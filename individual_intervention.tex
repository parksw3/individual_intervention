...
\jd{We should talk briefly before moving forward. I am thinking it would be good to have a general framework and then move to considering examples of constant-strength, constant-speed, and combinations of both (which are still not the general case, but basically all that we want to cover here). I think we should roll $S(t)$ into constant-strength ``changes''. The discussion of generalizing, and of X-``like'' changes can be brief and done in Discussion. Let me know what you think.}
...
\jd{This \P\ is a bit weird. I like the equation but it definitely feels like we've already been over the fact that these are different.}
