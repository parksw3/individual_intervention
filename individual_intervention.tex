...
\newline
\\
Sang Woo Park\textsuperscript{1,*}, Kaiyuan Sun, Benjamin M. Bolker, Joshua S. Weitz, Bryan T. Grenfell, Jonathan Dushoff, \swp{and others to be added}
\\
\bigskip
...
needed after we get comments from everyone
...
Note, however, that in the general case the “instantaneous” \Ri\ depends on past values of $\gamma$: the “conditions” that are held constant refer not to the current value of $\gamma$ but to the current distribution of the kernel across $\tau$.
\jd{In some cases it will be of interest to define yet another (even-more-instantaneous) reproductive number. Might be hard to squeeze into this framework, but might be worth discussing.}
